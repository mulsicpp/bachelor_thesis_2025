...
namespace vk {
	...
	private:
		ptr::Shared<RenderPass> _render_pass{};
	...
	public:
		...
		inline const ptr::Shared<RenderPass>& render_pass() const { return _render_pass; }
	...
	public:
		...
		Ref images(const std::vector<ptr::Shared<Image>>& images) { _images = images; return *this; }
		Ref add_image(Image&& image) { _images.push_back(std::move(image).to_shared()); return *this; }
		Ref add_image(const ptr::Shared<Image>& image) { _images.push_back(std::move(image)); return *this; }
