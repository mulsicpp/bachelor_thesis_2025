...
\chapter{Technologies}\label{chapter:methods}
...
\subsection{VMA (Vulkan Memory Allocator)}
...
CLI11 is a header-only library written in modern C++, that is designed to parse the command-line options of your application.It is simple, feature-rich and safe. CLI11 allows you to define flags, options, commands and subcommands. Your can also add certain restrictions to your parameters, like only allowing positive numbers or that a parameter is an existing path.